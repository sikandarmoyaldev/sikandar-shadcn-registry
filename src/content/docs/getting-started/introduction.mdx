---
title: Introduction
description: Sikandar Registry is a collection of accessible components built for use with Shadcn.
---
...
If there are any components that you would like to see added to this library, please feel free to open an issue on the <a href={PUBLIC_GITHUB_REPO_URL}>GitHub repository</a>.
